...
@interface XLsn0wPageController () {
...
@implementation XLsn0wPageController
...
- (void)wm_addScrollView {
    XLsn0wScrollView *scrollView = [[XLsn0wScrollView alloc] init];
...
- (void)wm_addMenuView {
    ...
    XLsn0wMenuView *menuView = [[XLsn0wMenuView alloc] initWithFrame:frame];
...
- (void)wm_adjustMenuViewFrame {
    ...
    if (self.showOnNavigationBar && self.navigationController.navigationBar) {
        [self.navigationController.navigationBar.subviews enumerateObjectsUsingBlock:^(UIView* obj, NSUInteger idx, BOOL *stop) {
            if (![obj isKindOfClass:[XLsn0wMenuView class]] && ![obj isKindOfClass:NSClassFromString(@"_UINavigationBarBackground")] && obj.alpha != 0 && obj.hidden == NO) {
