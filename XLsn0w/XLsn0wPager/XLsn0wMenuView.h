...
@optional
- (void)menuView:(XLsn0wMenuView *)menu didSelesctedIndex:(NSInteger)index currentIndex:(NSInteger)currentIndex;
- (CGFloat)menuView:(XLsn0wMenuView *)menu widthForItemAtIndex:(NSInteger)index;
- (CGFloat)menuView:(XLsn0wMenuView *)menu itemMarginAtIndex:(NSInteger)index;
- (CGFloat)menuView:(XLsn0wMenuView *)menu titleSizeForState:(WMMenuItemState)state;
- (UIColor *)menuView:(XLsn0wMenuView *)menu titleColorForState:(WMMenuItemState)state;
- (void)menuView:(XLsn0wMenuView *)menu didLayoutItemFrame:(XLsn0wMenuItem *)menuItem atIndex:(NSInteger)index;
@end

@protocol WMMenuViewDataSource <NSObject>

@required
- (NSInteger)numbersOfTitlesInMenuView:(XLsn0wMenuView *)menu;
- (NSString *)menuView:(XLsn0wMenuView *)menu titleAtIndex:(NSInteger)index;
 ...
 */
- (UIView *)menuView:(XLsn0wMenuView *)menu badgeViewAtIndex:(NSInteger)index;
 ...
 */
- (XLsn0wMenuItem *)menuView:(XLsn0wMenuView *)menu initialMenuItem:(XLsn0wMenuItem *)initialMenuItem atIndex:(NSInteger)index;

@end

@interface XLsn0wMenuView : UIView

@property (nonatomic, strong) NSArray *progressWidths;
@property (nonatomic, weak) XLsn0wProgressView *progressView;
