 ...
 */
- (NSInteger)numbersOfChildControllersInPageController:(XLsn0wPageController *)pageController;
 ...
 */
- (__kindof UIViewController *)pageController:(XLsn0wPageController *)pageController viewControllerAtIndex:(NSInteger)index;
 ...
 */
- (NSString *)pageController:(XLsn0wPageController *)pageController titleAtIndex:(NSInteger)index;
 ...
 */
- (void)pageController:(XLsn0wPageController *)pageController lazyLoadViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(XLsn0wPageController *)pageController willCachedViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(XLsn0wPageController *)pageController willEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(XLsn0wPageController *)pageController didEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;

@end

@interface XLsn0wPageController : UIViewController <WMMenuViewDelegate, WMMenuViewDataSource, UIScrollViewDelegate, WMPageControllerDataSource, WMPageControllerDelegate>
...
/** 顶部导航栏 */
@property (nonatomic, weak) XLsn0wMenuView *menuView;

/** 内部容器 */
@property (nonatomic, weak) XLsn0wScrollView *scrollView;
